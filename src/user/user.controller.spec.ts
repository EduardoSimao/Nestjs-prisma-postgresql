...
import { updatePatchUserDTOData, updateUserDTOData } from "../testing/update-user-dto.mock";
...
describe('UserController', () => {
    ...
    describe('Update', () =>{
        ...
        test('Update Partial method', async () =>{
            const result = await userController.updatePartial(updatePatchUserDTOData, 1);
